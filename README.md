<!--
 * @Author: KG
 * @Date: 2026-06-16 15:55:29
 * @LastEditors: KG
 * @LastEditTime: 2026-06-16 16:10:40
 * @FilePath: \1111\README.md
 * @Description:
 *
-->
...
> **注意：** 云函数使用了 `fetch` API，需要 **Node.js 18** 运行环境。在 CloudBase 控制台 → 云函数 → generate-text → 运行环境 → 选择 Node 18。
